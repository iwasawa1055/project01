var AppOutboundClosetInputAddress =
  {
    init: function() {
      AppOutboundClosetInputAddress.triggerDatetime();
      AppOutboundClosetInputAddress.autoKana();
      AppOutboundClosetInputAddress.backProcess();
    },
    triggerDatetime: function() {
      // 初期表示
      if ($('#address_id').val() != 'add') {
        AppOutboundClosetInputAddress.getDateTime(true);
      }
      ...
      $("#address_id").change(function(){
        AppOutboundClosetInputAddress.getDateTime(false);
      });
...
$(function()
  {
    AppOutboundClosetInputAddress.init();
