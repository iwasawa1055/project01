...
<section id="form">
  <div class="container">
    ...
    <div class="row">
    <?php echo $this->Form->create(false, ['url' => ['controller' => 'PurchaseEntryRegister', 'action' => 'complete']]); ?>
      <div class="form">
        <div class="a-confirm">
          <h3>メールアドレス</h3>
          <div class="form-group">
            <p><?php echo h($customerInfo['email']); ?></p>
          </div>
          <div class="form-group">
            <label>ニュースレターの配信</label>
            <p><?php echo CUSTOMER_NEWSLETTER[$customerInfo['newsletter']] ?></p>
          </div>
          <h3>お届け先情報</h3>
          <div class="form-group">
            <label>郵便番号</label>
          ...
          <div class="btn-orrection">
            <a href="/purchase/entry_register/address" class="animsition-link btn">お届け先情報を修正する</a>
          </div>
        </div>
        <div class="c-confirm">
          <h3>クレジットカード情報</h3>
          ...
          <div class="btn-orrection">
            <a href="/purchase/entry_register/credit" class="animsition-link btn">クレジットカード情報を修正する</a>
          </div>
        </div>
      </div>
      <div class="row">
