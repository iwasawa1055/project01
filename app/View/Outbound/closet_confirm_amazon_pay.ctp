    <?php
    $this->Html->script('outbound/closet_confirm_amazon_pay', ['block' => 'scriptMinikura']);
    ?>
              ...
              <ul class="ls-conf-item">
                  <?php foreach($outbound_item_list as $k => $v): ?>
                    <li>
                      ...
                      <p class="l-conf-item-price"><?php echo CLOSET_OUTBOUND_PER_ITEM_PRICE; ?>円</p>
                    </li>
                  <?php endforeach; ?>
                <li>
                  <p class="l-conf-item-pict"></p>
                  <p class="l-conf-item-name">基本料金</p>
                  <p class="l-conf-item-price"><?php echo CLOSET_OUTBOUND_BASIC_PRICE; ?>円</p>
                </li>
                <li>
                  <p class="l-conf-item-pict"></p>
    ...
    <div class="nav-fixed">
      <ul>
        <li><a class="btn-d-gray" href="/outbound/closet_input_address_amazon_pay">戻る</a></li>
