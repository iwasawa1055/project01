...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div id="wrapper">
                ...
                <li>
                    ...
                    <ul class="li-libry-item">
                        ...
                        <li>
                            ...
                            <p class="li-libry-item-price"><?php echo LIBRARY_OUTBOUND_PER_ITEM_PRICE; ?>円</p>
                        </li>
                        <?php endforeach; ?>
                        <li>
                            <p class="li-libry-item-pict"></p>
                            <p class="li-libry-item-name">基本料金</p>
                            <p class="li-libry-item-price"><?php echo LIBRARY_OUTBOUND_BASIC_PRICE; ?>円</p>
                        </li>
                        <li>
                            <p class="li-libry-item-pict"></p>
        ...
        <div class="nav-fixed">
            <ul>
                <li><a class="btn-d-gray" href="/outbound/library_input_address_amazon_pay">戻る</a></li>
    ...
    <?php
      ...
      $this->Html->script('outbound/library_confirm_amazon_pay', ['inline' => false]);
