            ...
            <?php echo $this->Form->create('Inquiry', ['url' => ['controller' => 'inquiry', 'action' => 'confirm'], 'inputDefaults' => ['label' => false, 'div' => false], 'novalidate' => true]); ?>
              <div class="col-lg-12 none-title">
                ...
                <div id="bug_area">
                  <div class="form-group col-lg-12">
                    <label>不具合発生日時</label>
                    <?php echo $this->Form->input('Inquiry.bug_datetime', ['class' => "form-control", 'error' => false]); ?>
                  ...
                  <div class="form-group col-lg-12">
                    ...
                    <?php echo $this->Form->input('Inquiry.bug_environment', ['class' => "form-control", 'error' => false]); ?>
