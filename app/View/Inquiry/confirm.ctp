            ...
            <div class="row">
              <div class="col-lg-12 none-title">
                <div class="form-group col-lg-12">
                  <label>お名前</label>
                  <p class="form-control-static">市川倫之介</p>
                </div>
                <div class="form-group col-lg-12">
                  <label>メールアドレス</label>
                ...
                <div class="form-group col-lg-12">
                  <label>お知らせメール</label>
                  <p class="form-control-static">受信しない</p>
                </div>
                <div class="form-group col-lg-12">
                ...
                <a class="btn btn-primary btn-lg btn-block animsition-link" href="add.html">戻る</a>
                </span>
                <span class="col-lg-6 col-md-6 col-xs-12">
                <a class="btn btn-danger btn-lg btn-block animsition-link" href="/inquiry/complete">この内容で問い合わせる</a>
                </span>
              </div>
            </div>
          </div>
