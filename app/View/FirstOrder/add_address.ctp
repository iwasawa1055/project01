...
<?php echo $this->element('FirstOrder/nav'); ?>
  ...
  <!-- ADRESS -->
  <form method="post" action="/first_order/confirm_address">
  <section id="adress">
    <div class="wrapper">
      <div class="form">
      ...
      <div class="form">
        ...
        <input type="tel" name="postal" id="postal" class="postal search_address_postal" placeholder="0123456" size="8" maxlength="8" value="<?php echo CakeSession::read('Address.postal');?>">
        <?php echo $this->Flash->render('postal');?>
      </div>
      <div class="form">
        <label>都道府県<span class="required">※</span></label>
        <input type="text" name="pref" class="adress1 address_pref" placeholder="東京都" size="28" maxlength="50" value="<?php echo CakeSession::read('Address.pref');?>">
        <?php echo $this->Flash->render('pref');?>
      </div>
      <div class="form">
        <label>住所<span class="required">※</span></label>
        <input type="text" name="address1" class="adress1 address_address1" placeholder="品川区" size="28" maxlength="50" value="<?php echo CakeSession::read('Address.address1');?>">
        <?php echo $this->Flash->render('address1');?>
      </div>
      <div class="form">
        <label>番地<span class="required">※</span></label>
        <input type="text" name="address2" class="adress2 address_address2" placeholder="東品川2-2-28" size="28" maxlength="50" value="<?php echo CakeSession::read('Address.address2');?>">
      ...
      <div class="form">
        ...
        <input type="tel" name="tel1" class="tel" placeholder="01234567890" size="15" maxlength="15" value="<?php echo CakeSession::read('Address.tel1');?>">
