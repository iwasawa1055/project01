  ...
  <section id="adress">
    <div class="wrapper">
      <div class="form">
        ...
        <input type="text" class="name" name="card_no" placeholder="0000-0000-0000-0000" size="20" maxlength="20" value="<?php echo CakeSession::read('Credit.card_no');?>" required>
      ...
      <div class="form">
        ...
        <input type="text" class="adress2" name="holder_name" placeholder="TERRADA MINIKURA" size="28" maxlength="30" value="<?php echo CakeSession::read('Credit.holder_name');?>" required>
