    ...
    <div class="wrapper">
      ...
      <div class="form">
        <label class="terms"><input type="checkbox" class="term agree-before-submit focused" id="term" name="remember" value="Remember Me"><span class="check-icon"></span>
          <label for="term" class="term select_agreement"><a href="https://minikura.com/use_agreement/" target="_blank" class="dsn-link-terms">minikura利用規約</a>と<a href="https://minikura.com/privacy/" target="_blank" class="dsn-link-terms">個人情報の取扱いについて</a>に同意する</label>
        </label>
