    <section class="registry">
        <div class="container">
            ...
            <ul class="input-form">
                <li>
                    <label>紹介コード</label>
                    <p class="confirm"><?php echo h($CustomerRegistInfo['alliance_cd']); ?></p>
                </li>
                <li>
            ...
            <ul class="nav-block-2">
                <li><a class="btn-d-gray" href="/customer/register/add_entry">戻る</a></li>
                <li><a class="btn-d-red" href='/customer/register/complete_entry'>完了</a></li>
            </ul>
        </div>
    </section>
