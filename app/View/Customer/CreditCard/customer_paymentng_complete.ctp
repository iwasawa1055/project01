            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group col-lg-12">
                  ...
                  お支払いが完了するまでの間は、利用可能なカード情報にご変更頂いた場合でも、<br />
                  ログインの制限がかかっておりますので、予めご了承ください。<br />
                  </p>
                </div>
                <span class="col-lg-12 col-md-12 col-xs-12">
                  <a class="btn btn-danger btn-lg btn-block" href="/login/logout?paymentng=false">ログアウト</a>
                </span>
              </div>
            </div>
          </div>
