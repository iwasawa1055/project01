            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <div class="form-group col-lg-12">
                  <?php echo $this->Form->input('CustomerInfoV3.postal', ['class' => "form-control", 'placeholder'=>'郵便番号（入力していただくと以下の入力がスムーズに行なえます）', 'error' => false]); ?>
                  <?php echo $this->Form->error('CustomerInfoV3.postal', null, ['wrap' => 'p']) ?>
                </div>
                <div class="form-group col-lg-12">
                  <?php echo $this->Form->input('CustomerInfoV3.pref', ['class' => "form-control", 'placeholder'=>'都道府県', 'error' => false]); ?>
                  <?php echo $this->Form->error('CustomerInfoV3.pref', null, ['wrap' => 'p']) ?>
                </div>
                <div class="form-group col-lg-12">
                  <?php echo $this->Form->input('CustomerInfoV3.address1', ['class' => "form-control", 'placeholder'=>'住所', 'error' => false]); ?>
                  <?php echo $this->Form->error('CustomerInfoV3.address1', null, ['wrap' => 'p']) ?>
                </div>
                <div class="form-group col-lg-12">
                  <?php echo $this->Form->input('CustomerInfoV3.address2', ['class' => "form-control", 'placeholder'=>'番地', 'error' => false]); ?>
