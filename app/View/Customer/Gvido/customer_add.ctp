...
?>
    <section class="registry">
        <div class="container">
            <?php echo $this->Form->create('CustomerRegistInfo', ['url' => ['controller' => 'gvido', 'action' => 'customer_add'], 'inputDefaults' => ['label' => false, 'div' => false], 'novalidate' => true]); ?>
            <h2>お客様情報</h2>
            <ul class="input-form">
                <li>
            ...
            <ul class="input-form">
                <li>
                    ...
                    <p class="description">GVIDO会員様限定特典コード「gvido」が記入されているかご確認ください。</p>
                </li>
                <li>
