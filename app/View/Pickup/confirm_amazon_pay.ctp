...
<div class="row">
<?php echo $this->Form->create('PickupAddress', ['url' => '/pickup/complete_amazon_pay', 'inputDefaults' => ['label' => false, 'div' => false], 'novalidate' => true ]); ?>
  <div class="col-lg-12">
        ...
        <div class="row">
          <div class="col-lg-12 none-title">
            ...
            <span class="col-lg-6 col-md-6 col-xs-12">
                <?php echo $this->Html->link('戻る', ['controller' => 'pickup', 'action' => 'edit_amazon_pay', '?' => ['back' => 'true', 'return' => Hash::get($this->request->query, 'return')]], ['class' => 'btn btn-primary btn-lg btn-block']); ?>
            </span>
            <span class="col-lg-6 col-md-6 col-xs-12">
