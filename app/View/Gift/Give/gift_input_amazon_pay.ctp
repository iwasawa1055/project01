      ...
      <div class="l-present-mail" id="address1">
        <ul class="input-info">
          <li>
            ...
            <?php echo $this->Form->input("PaymentAmazonGiftAmazonPay.email", ['id' => 'email', 'class' => "cb-square", 'placeholder'=>'受け取る人のメールアドレスを入力ください', 'size' => '28', 'maxlength' => '50', 'autocomplete' => "cc-csc", 'error' => false, 'label' => false, 'div' => false]); ?>
            <?php echo $this->Form->error("PaymentAmazonGiftAmazonPay.email", null, ['wrap' => 'p', 'class' => 'valid-il']) ?>
