<div id="page-wrapper" class="wrapper outbound">
  ...
  <p class="page-caption">以下の内容でminikuraCLEANING＋の申し込みを行います。</p>
  <ul class="l-cfm">
    <li>
      <ul class="l-cfm-item">
...
<div class="nav-fixed">
  <ul>
    <li><a class="btn-d-gray animsition-link" href="/cleaning/input">戻る</a>
    </li>
    <li><a class="btn-red" href="/cleaning/complete">完了</a>
    </li>
  </ul>
</div>
