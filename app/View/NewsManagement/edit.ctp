      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            <?php echo $this->Form->create('News', ['url' => '/news_management/detail/'. $news['id'] . '/edit', 'inputDefaults' => ['label' => false, 'div' => false], 'novalidate' => true]); ?>
                ...
                <div class="form-group col-lg-12">
                <label>日時</label>
                  <?php echo $this->Form->input('News.date', ['class' => "form-control", 'placeholder'=>'作成日時（yyyy/mm/dd hh:ii）', 'error' => false]); ?>
            ...
            <?php echo $this->Form->create('News', ['url' => '/news_management/detail/' . $news['id'] . '/delete', 'inputDefaults' => ['label' => false, 'div' => false], 'novalidate' => true]); ?>
                <span class="col-lg-6 col-md-6 col-xs-12">
