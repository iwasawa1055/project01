      ...
      <?php } else { ?>
        ...
        <li> <a href="#"><i class="fa fa-tags fa-fw"></i> ご利用中のサービス<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li> <a class="animsition-link" href="box/list.html"><i class="fa fa-tag fa-fw"></i> MONO（00箱）</a> </li>
        ...
        <li> <a href="#"><i class="fa fa-arrow-circle-o-up fa-fw"></i> 預け入れ<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li> <a class="animsition-link" href="deposit/box.html"><i class="fa fa-arrow-circle-o-up fa-fw"></i> ボックス預け入れ</a> </li>
            <li> <a class="animsition-link" href="deposit/shoes.html"><i class="fa fa-arrow-circle-o-up fa-fw"></i> シューズクリーニング</a> </li>
            <li> <a class="animsition-link" href="deposit/boxless.html"><i class="fa fa-arrow-circle-o-up fa-fw"></i> ボックスレス</a> </li>
          </ul>
        </li>
