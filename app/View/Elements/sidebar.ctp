      ...
      <?php } else { ?>
        ...
        <li> <a href="#"><i class="fa fa-tags fa-fw"></i> ご利用中のサービス<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li> <a class="animsition-link" href="/box?product=mono"><i class="fa fa-tag fa-fw"></i> MONO（<?php echo array_key_exists('004024', $product_summary) ? ($product_summary['004024']) : 0; ?>箱）</a> </li>
            <li> <a class="animsition-link" href="/box?product=hako"><i class="fa fa-tag fa-fw"></i> HAKO（<?php echo array_key_exists('004025', $product_summary) ? ($product_summary['004025']) : 0; ?>箱）</a> </li>
            <li> <a class="animsition-link" href="/box?product=cleaning"><i class="fa fa-tag fa-fw"></i> クリーニングパック（<?php echo array_key_exists('004029', $product_summary) ? ($product_summary['004029']) : 0; ?>箱）</a> </li>
          </ul>
        </li>
