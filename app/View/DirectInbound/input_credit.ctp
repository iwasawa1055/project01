        ...
        <div class="panel panel-default">
          <div class="panel-body">
            <div class="row">
              <div class="col-lg-12">
                <h2>クレジットカード情報の入力</h2>
                <form method="post" action="/direct_inbound/confirm_credit" novalidate>
                <div class="form-group col-lg-12">
                  <input type="tel" class="form-control" name="card_no" placeholder="0000-0000-0000-0000" size="20" maxlength="20" value="<?php echo CakeSession::read('Credit.card_no');?>">
                ...
                <div class="form-group col-lg-12">
                  <input type="tel" class="form-control" name="security_cd" placeholder="0123" size="6" maxlength="6" value="">
