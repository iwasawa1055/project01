...
<?php $this->validationErrors['OrderKit'] = $validErrors; ?>
    ...
    <div class="row">
      <form method="post" class="select-add-address-form" action="/direct_inbound/complete_amazon_pay" novalidate>
        <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                          <div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 col-xs-12">
                              <label> <?php echo CakeSession::read('DirectInbound.direct_inbound.direct_inbound') ?>個</label>
                            </div>
                          </div>
                        </div>
