        ...
        <div class="panel panel-default">
          ...
          <?php echo $this->Form->create('Box', ['url' => '/box/detail/'.$box['box_id'].'/edit', 'inputDefaults' => ['label' => false, 'div' => false], 'novalidate' => true]); ?>
            ...
            <span class="col-lg-6 col-md-6 col-xs-12">
              <a class="btn btn-primary btn-lg btn-block animsition-link" href="/box/detail/<?php echo $box['box_id'] ?>">ボックスの詳細に戻る</a>
            </span>
            <span class="col-lg-6 col-md-6 col-xs-12">
              <button type="submit" class="btn btn-danger btn-lg btn-block page-transition-link">ボックス情報を保存する</button>
            </span>
