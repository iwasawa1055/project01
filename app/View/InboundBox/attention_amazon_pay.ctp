...
$this->Html->script('inbound_box/attention_amazon_pay', ['block' => 'scriptMinikura']);
            ...
            <li>
              <ul class="input-info" id="dev_collect" <?php echo (isset($this->request->data['InboundBase']['delivery_carrier']) && $this->request->data['InboundBase']['delivery_carrier'] == '7') ? 'style="display:none"' : ''; ?>>
                ...
                <li class="name-form-group">
                  ...
                  <?php echo $this->Form->input("InboundBase.lastname", ['type' => 'text', 'class' => 'lastname', 'placeholder'=>'例：寺田', 'size' => '10', 'maxlength' => '30', 'autocomplete' => "family-name", 'error' => false, 'label' => false, 'div' => false]); ?>
                  <?php echo $this->Form->error("InboundBase.lastname", null, ['wrap' => 'p', 'class' => 'valid-il']) ?>
                </li>
                <li class="name-form-group">
                  <label class="headline">お名前 (名)</label>
                  <?php echo $this->Form->input("InboundBase.firstname", ['type' => 'text', 'class' => 'firstname', 'placeholder'=>'例：太郎', 'size' => '10', 'maxlength' => '30', 'autocomplete' => "given-name", 'error' => false, 'label' => false, 'div' => false]); ?>
