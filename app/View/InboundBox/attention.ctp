...
<?php $this->Html->script('gmoCreditCardPayment', ['block' => 'scriptMinikura']); ?>
        ...
        <?php echo $this->Form->create('InboundBase', ['url' => '/inbound/box/confirm', 'name' => 'form', 'inputDefaults' => ['label' => false, 'div' => false], 'novalidate' => true]); ?>
        <div id="page-wrapper" class="wrapper inbound">
            ...
            <div id="gift" class="item-content">
                <ul class="grid grid-md">
                    <?php foreach ($target_box_list as $key => $box_data): ?>
                    <li>
                        <label>
                            <span class="item-img">
                        ...
                        <?php if($box_data['product_cd'] === 'todo gift product cd'): ?>
                        <div class="l-slct-num">
                            <p class="ttl-slct-num">預け入れ点数</p>
                            <ul class="list-slct-num">
                                <li>
                                    <label class="input-check">
                                        <input type="radio" class="rb" name="data[InboundBase][item_excess[<?php echo $key; ?>]]" value="0" checked><span class="icon"></span>
                                        <span class="label-txt">5点以内</span>
                                    </label>
                                </li>
                                <li>
                                    <label class="input-check">
                                        <input type="radio" class="rb" name="data[InboundBase][item_excess[<?php echo $key; ?>]]" value="1"><span class="icon"></span>
