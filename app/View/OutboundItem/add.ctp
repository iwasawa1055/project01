        ...
        <div class="panel panel-default">
          <div class="panel-body">
                      ...
                      <div class="panel-body">
                        <div class="row">
                          <div class="col-lg-2 col-md-2 col-sm-12">
                            <a class="animsition-link" href="../item/detail.html"><img src="/img/xxx_xxxx.jpg" alt="xxx_xxxx" width="100px" height="100px" class="item"></a>
                          </div>
                          <div class="col-lg-6 col-md-6 col-sm-12">
                            <h3>
                            <a class="animsition-link" href="../item/detail.html">S.H.Figuarts ファースト・オー…</a>
                          </div>
                          <div class="col-lg-4 col-md-4 col-xs-12">
                            <a class="btn btn-warning btn-md btn-block btn-detail">取り出しリストから削除</a>
                          </div>
                        </div>
                      </div>
                      <div class="panel-footer">
                        <div class="row">
                          <div class="col-lg-10 col-md-10 col-sm-12">
                            <p class="box-list-caption"><span>収納ボックスID</span>xxx-xxx</p>
                  ...
                  <div class="col-lg-12">
                    <div class="panel panel-default">
                      <div class="panel-body hako-box">
                        <div class="row">
                          <div class="col-lg-8 col-md-8 col-sm-12">
                            <h3><a class="animsition-link" href="../hako/detail.html">夏服①②夏服①②夏服①②夏服①…</a>
                            </h3>
                          </div>
                          <div class="col-lg-4 col-md-4 col-xs-12">
                            <a class="btn btn-warning btn-md btn-block btn-detail">取り出しリストから削除</a>
                  ...
                  <div class="col-lg-12">
                    <div class="panel panel-default">
                      <div class="panel-body cleaning-box">
                        <div class="row">
                          <div class="col-lg-8 col-md-8 col-sm-12">
                            <h3><a class="animsition-link" href="../cleaning/detail.html">衣類（箱のタイトルが入ります）…</a>
                            </h3>
                          </div>
                          <div class="col-lg-4 col-md-4 col-xs-12">
                            <a class="btn btn-warning btn-md btn-block btn-detail">取り出しリストから削除</a>
            ...
            <span class="col-lg-6 col-md-6 col-xs-6">
              <a class="btn btn-primary btn-lg btn-block animsition-link" href="item.html">アイテムを選択に戻る</a>
            </span>
            <span class="col-lg-6 col-md-6 col-xs-6">
              <a class="btn btn-primary btn-lg btn-block animsition-link" href="box.html">ボックスを選択に戻る</a>
            </span>
            <span class="col-lg-12 col-md-12 col-xs-12">
              <a class="btn btn-danger btn-lg btn-block animsition-link" href="/outbound/item/confirm">この内容で確認する</a>
            </span>
          </div>
        </div>
      </div>
