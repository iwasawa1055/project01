...
switch (true) {
    ...
    case $_SERVER['SERVER_NAME'] === 'sato-mypage.minikura.com':
        ...
        $config['api.minikura.access_point.facebook_v5'] = $url . '/v5/facebook';
        break;
    case $_SERVER['HTTP_HOST'] === 'yanai-www.minikura.com':
    case $_SERVER['SERVER_NAME'] === 'yanai-mypage.minikura.com':
        $config['site.mypage.url'] = 'https://yanai-mypage.minikura.com';
        $config['site.static_content_url'] = 'https://yanai-www.minikura.com';
